                  ...
                  <!-- 다음버튼 -->
                   <div class="text-center">
                        <ul class="pagination justify-content-center" style="margin:20px 0">
							...
							<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath }/reviewboard/search_review?pageNum=${pageDTO.startPage-pageDTO.pageBlock}%search=${pageDTO.search}">◁</a></li>
							</c:if>
							
							<c:forEach var="i" begin="${pageDTO.startPage }" end="${pageDTO.endPage }" step="1">
							<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath }/reviewboard/search_review?pageNum=${i}%search=${pageDTO.search}"> ${i}</a></li>
							</c:forEach>
